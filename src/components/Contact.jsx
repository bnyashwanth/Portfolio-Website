    ...
    <section id="contact" className="py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-surface/30">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Contact Form */}
          <div
            className="bg-surface/50 backdrop-blur-sm rounded-2xl p-6 md:p-8 border border-gray-200/50 dark:border-gray-800/50 shadow-md dark:shadow-none hover:shadow-lg hover:border-purple-500/50 transition-all duration-300"
            data-aos="fade-right"
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 rounded-xl bg-background/50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-800 text-text-primary placeholder-text-muted/70 focus:outline-none focus:border-purple-500 transition-colors backdrop-blur-sm"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows="5"
                  className="w-full px-4 py-3 rounded-xl bg-background/50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-800 text-text-primary placeholder-text-muted/70 focus:outline-none focus:border-purple-500 transition-colors resize-none backdrop-blur-sm"
